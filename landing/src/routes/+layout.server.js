...
export const load = async () => {
  const colorPairs = [
    ...
    ['#10069F', '#FFFBC1', '/drawings/2.webp', '/drawings/2-mobile.webp',
     ...
     '/img/table.webp','max-width: 75vw; max-height: 34vh; top: 44%; left: 50%; transform: translate(-50%, -50%)'],
    ['#FFFBC1', '#10069F', '/drawings/3.webp', '/drawings/3-mobile.webp',
     ...
     '/img/armchair.webp', 'max-width: 90vw; max-height: 37vh; top: 45%; left: 50%; transform: translate(-50%, -50%)'],
  ];
